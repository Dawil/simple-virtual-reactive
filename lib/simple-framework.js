  ...
  for (var i = 0; i < arguments.length; i+=2) {
    ...
    for (var eventType in routing) {
      ...
      for (var d in destinations) {
        // Should tell this to instead call 
        //   destinations[d][eventType]()
        // when the event fires (using closure)
        // so that object definitions can use prototype.
        // Should also enable single fire events and disabling events.
